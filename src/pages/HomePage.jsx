      ...
      <div className="min-h-screen relative flex items-center flex-col justify-center gap-10">
        ...
        <div className="relative z-99 w-full">
          ...
          <div>
            <CardsPortrait 
            cards={[
                    { title: "MaFIA Inclusive Bootcamp (Massive Camp)", body: "Kementerian Kajian & Aksi Strategis", color: "#FDC2D6" },
                    { title: "MaFIA Business Summit (MBS)", body: "Biro Ekonomi Kreatif", color: "#FDC2D6" },
                    { title: "MaFIA Industry Insight (Minsight)", body: "Kementerian Dalam & Luar Negeri", color: "#FDC2D6" },
                  ]} />
            <CardsPortrait 
            cards={[
              { title:"MaFIA Talent Project (Mata Project)", body: "Kementerian Pemberdayaan Mahasiswa",color:"#F0BD51"},
              { title:"MaFIA Efficiency Boost (MaFEst)", body: "Satuan Pendayagunaan Aparatur & Reformasi Organisasi",color:"#F0BD51"},
              { title:"MaFIA Research Innovation Forum (Marinovation)", body: "Kementerian Riset & Inovasi Karya",color:"#F0BD51"},
        ...
        <div className="w-full bg-[#FEFEFE] flex items-center border-t-[3.5px] border-b-[3.5px] z-99">
          ...
          <div className="w-full flex justify-center items-center sm:relative absolute lg:top-0 bottom-[45px]">
            <svg  viewBox="0 0 135 336" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute z-50 sm:w-[130px] sm:h-[250px]  h-36  ">
              ...
              <rect x="27" y="75.4805" width="4" height="189" transform="rotate(-21.7685 27 75.4805)" fill="#98A869"/>
              <rect width="4" height="189" transform="matrix(-0.92869 -0.370858 -0.370858 0.92869 100.807 75.4805)" fill="#98A869"/>
              <path d="M64.5 4C96.8087 4 123 30.1913 123 62.5C123 94.8087 96.8087 121 64.5 121C32.1913 121 6 94.8087 6 62.5C6 30.1913 32.1913 4 64.5 4ZM64.5 50C57.5964 50 52 55.5964 52 62.5C52 69.4036 57.5964 75 64.5 75C71.4036 75 77 69.4036 77 62.5C77 55.5964 71.4036 50 64.5 50Z" fill="#F0BD51"/>
              <path d="M64.5 205C96.8087 205 123 231.191 123 263.5C123 295.809 96.8087 322 64.5 322C32.1913 322 6 295.809 6 263.5C6 231.191 32.1913 205 64.5 205ZM64.5 251C57.5964 251 52 256.596 52 263.5C52 270.404 57.5964 276 64.5 276C71.4036 276 77 270.404 77 263.5C77 256.596 71.4036 251 64.5 251Z" fill="#F0BD51"/>
